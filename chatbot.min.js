...
What type of business do you run? This helps me prepare specific insights for your audit.`}else if(t.includes('checklist')||t.includes('download')||t.includes('guide')){n=`🎁 Perfect! I've prepared a **Google Ads Checklist** that's helped businesses increase conversions by 200%!
...
Just enter your email and I'll send it over immediately. No spam, ever!`}else if(t.includes('consultation')||t.includes('call')||t.includes('meeting')){n=`🗓️ Excellent choice! Marlon offers **free 30-minute strategy calls** with zero obligation.
